...
using IAudioSessionControl = VolumeChanger.CoreAudio.Interfaces.IAudioSessionControl;

namespace VolumeChanger.CoreAudio
{
    public class AudioSessionControl : IAudioSessionControl, IDisposable
    {
        internal Internal.Interfaces.WASAPI.IAudioSessionControl _AudioSessionControl;
        ...
        private readonly AudioSessionEvents _AudioSessionEvents;

        internal AudioSessionControl(Internal.Interfaces.WASAPI.IAudioSessionControl realAudioSessionControl)
        {
