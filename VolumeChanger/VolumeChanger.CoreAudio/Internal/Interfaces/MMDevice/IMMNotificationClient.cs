...
using VolumeChanger.CoreAudio.Structures;

namespace VolumeChanger.CoreAudio.Internal.Interfaces.MMDevice
{
    [Guid(ComIIds.IMM_NOTIFICATION_CLIENT_IID), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
