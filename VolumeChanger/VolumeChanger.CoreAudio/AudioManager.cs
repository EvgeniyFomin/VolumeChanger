...
using VolumeChanger.CoreAudio.Interfaces;
...
namespace VolumeChanger.CoreAudio
{
    public static class AudioManager
    {
        ...
        {
            IAudioEndpointVolume masterVol = null;
            IAudioEndpointVolumeCallback callback = null;
            try
            {
                masterVol = GetMasterVolumeObject();
                if (masterVol == null)
                ...
                //callback = new AudioEndpointVolumeCallback(masterVol);
                //masterVol.RegisterControlChangeNotify(callback);
            ...
            finally
            {
                if (masterVol != null)
                {
                    //asterVol.UnregisterControlChangeNotify(callback);
